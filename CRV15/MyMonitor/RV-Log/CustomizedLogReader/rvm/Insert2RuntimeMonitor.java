...
final class Insert2Monitor_Set extends com.runtimeverification.rvmonitor.java.rt.tablebase.AbstractMonitorSet<Insert2Monitor> {
	...
	final void event_insert(String user, String db, String data, long tp) {
		int numAlive = 0 ;
		for(int i = 0; i < this.size; i++){
			...
			if(!monitor.isTerminated()){
				...
				monitor.Prop_1_event_insert(user, db, data, tp);
	...
	final void event_insert2DB2(String data, long tp) {
		int numAlive = 0 ;
		for(int i = 0; i < this.size; i++){
			Insert2Monitor monitor = this.elements[i];
			if(!monitor.isTerminated()){
				...
				final Insert2Monitor monitorfinalMonitor = monitor;
				monitor.Prop_1_event_insert2DB2(data, tp);
				if(monitorfinalMonitor.Prop_1_Category_fail) {
					monitorfinalMonitor.Prop_1_handler_fail();
				}
			}
	...
	final void event_insert2DB3(String data, long tp) {
		int numAlive = 0 ;
		for(int i = 0; i < this.size; i++){
			Insert2Monitor monitor = this.elements[i];
			if(!monitor.isTerminated()){
				...
				final Insert2Monitor monitorfinalMonitor = monitor;
				monitor.Prop_1_event_insert2DB3(data, tp);
				if(monitorfinalMonitor.Prop_1_Category_fail) {
					monitorfinalMonitor.Prop_1_handler_fail();
				}
			}
...
class Insert2Monitor extends com.runtimeverification.rvmonitor.java.rt.tablebase.AbstractAtomicMonitor implements Cloneable, com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	final boolean Prop_1_event_insert(String user, String db, String data, long tp) {
		{
	...
	final boolean Prop_1_event_insert2DB2(String data, long tp) {
		{}
	...
	final boolean Prop_1_event_insert2DB3(String data, long tp) {
		{}
...
public final class Insert2RuntimeMonitor implements com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	public static final void insertEvent(String user, String db, String data, long tp) {
		...
		matchedEntry.Prop_1_event_insert(user, db, data, tp);
	...
	public static final void insert2DB2Event(String data, long tp) {
		Insert2_activated = true;
		while (!Insert2_RVMLock.tryLock()) {
			Thread.yield();
		}
		...
		// D(X) main:8--9
		final Insert2Monitor matchedEntryfinalMonitor = matchedEntry;
		matchedEntry.Prop_1_event_insert2DB2(data, tp);
		if(matchedEntryfinalMonitor.Prop_1_Category_fail) {
			matchedEntryfinalMonitor.Prop_1_handler_fail();
		}
	...
	public static final void insert2DB3Event(String data, long tp) {
		Insert2_activated = true;
		while (!Insert2_RVMLock.tryLock()) {
			Thread.yield();
		}
		...
		// D(X) main:8--9
		final Insert2Monitor matchedEntryfinalMonitor = matchedEntry;
		matchedEntry.Prop_1_event_insert2DB3(data, tp);
		if(matchedEntryfinalMonitor.Prop_1_Category_fail) {
			matchedEntryfinalMonitor.Prop_1_handler_fail();
		}
