// Dafny program INode-append.dfy compiled into C#
...
public class @INode {
  ...
  public @INode @next = (@INode)null;
  public BigInteger @len() {
    if (((this).@next).@Equals((@INode)null)) {
      return new BigInteger(1);
    } else {
      return (new BigInteger(1)) + (((this).@next).@len());
    }
  }
  ...
  TAIL_CALL_START: ;
    var _this = this;
    @INode @_156_node = (@INode)null;
    var _nw0 = new @INode();
    @_nw0.@init(@d);
    @_156_node = _nw0;
    @INode @_157_tmpNd = (@INode)null;
    @_157_tmpNd = _this;
    { }
    { }
    { }
    while (!((@_157_tmpNd).@next).@Equals((@INode)null))
    {
      @_157_tmpNd = (@_157_tmpNd).@next;
      { }
    }
    (@_157_tmpNd).@next = @_156_node;
    { }
  }
}
