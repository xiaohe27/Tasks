...
public final class noStatsRuntimeMonitor implements com.runtimeverification.rvmonitor.java.rt.RVMObject {
	private static com.runtimeverification.rvmonitor.java.rt.map.RVMMapManager noStatsMapManager;
	static {
		noStatsMapManager = new com.runtimeverification.rvmonitor.java.rt.map.RVMMapManager();
		noStatsMapManager.start();
	}

	// Declarations for the Lock
	static final ReentrantLock noStats_RVMLock = new ReentrantLock();
	static final Condition noStats_RVMLock_cond = noStats_RVMLock.newCondition();
