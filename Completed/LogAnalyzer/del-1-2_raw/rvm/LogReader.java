...
import rvm.Delete12_RawRuntimeMonitor;

public class LogReader {

    private static HashSet<java.lang.String> monitoredEventSet = LogReader.initMonitoredEventsSet();
    public static Path outputPath = Paths.get("./test-out/violation.txt");
    protected static int maxNumOfParams = 4;
    private static HashMap<java.lang.String, int[]> methodInfo = LogReader.initMethodInfo();

    private static HashSet<java.lang.String> initMonitoredEventsSet() {
        HashSet<java.lang.String> setOfEvents = new HashSet<java.lang.String>();
        setOfEvents.add("insert");
        setOfEvents.add("delete");
        return setOfEvents;
    }

    public static boolean isMonitoredEvent(java.lang.String event) {
        return LogReader.monitoredEventSet.contains(event);
    }

    private static HashMap<java.lang.String, int[]> initMethodInfo() {
        HashMap<java.lang.String, int[]> methodInfoTable = new HashMap<java.lang.String, int[]>();
    ...
    static class MonitorMethodsInvoker {
        ...
        public static void invoke(java.lang.String eventName, Object[] data) {
            switch (eventName) {
                case "insert":
                    Delete12_RawRuntimeMonitor.insertEvent(((String) data[ 0 ]), ((String) data[ 1 ]), ((String) data[ 2 ]), ((String) data[ 3 ]));
                    break;
                case "delete":
                    Delete12_RawRuntimeMonitor.deleteEvent(((String) data[ 0 ]), ((String) data[ 1 ]), ((String) data[ 2 ]), ((String) data[ 3 ]));
                    break;
            }
        }
    ...
    public static void main(String[] args) throws IOException {
    	...
    	Delete12_RawRawMonitor.printAllViolations();
	}
}
/**
...
//            this.curParamIndex = typesInTuple.length - 1;
        ...
        //all the violations' output will be taken care of inside rvm-lib
        LogReader.MonitorMethodsInvoker.invoke(EventName, tupleData);
