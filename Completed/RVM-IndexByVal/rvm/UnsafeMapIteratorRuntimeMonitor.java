...
class SafeMapIteratorMonitor extends com.runtimeverification.rvmonitor.java.rt.tablebase.AbstractSynchronizedMonitor implements Cloneable, com.runtimeverification.rvmonitor.java.rt.RVMObject, ISafeMapIteratorMonitor {
	...
	int Prop_1_state;
	static final int Prop_1_transition_createColl[] = {3, 5, 5, 5, 5, 5};;
	static final int Prop_1_transition_createIter[] = {5, 5, 5, 4, 5, 5};;
	static final int Prop_1_transition_useIter[] = {5, 5, 1, 5, 4, 5};;
	static final int Prop_1_transition_updateMap[] = {5, 5, 2, 3, 2, 5};;
...
public final class UnsafeMapIteratorRuntimeMonitor implements com.runtimeverification.rvmonitor.java.rt.RVMObject {
